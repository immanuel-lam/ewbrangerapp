...
struct MoreView: View {
    ...
    private func tabDestinationBinding(_ key: String) -> Binding<Bool> {
        Binding(
            get: { selectedTab == key },
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationDestination(isPresented: tabDestinationBinding("meshSync")) {
                DemoMeshSyncView()
            }
            .navigationDestination(isPresented: tabDestinationBinding("tasks")) {
                TaskListView()
            }
            .navigationDestination(isPresented: tabDestinationBinding("pesticide")) {
                PesticideListView()
            }
            .navigationDestination(isPresented: tabDestinationBinding("sightings")) {
                SightingListView()
            }
        }
    }
